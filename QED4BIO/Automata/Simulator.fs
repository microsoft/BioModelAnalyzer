...
let simple_automata_B_1<'istate when 'istate : comparison> : Automata<'istate,interp> -> SimpleAutomata<int, interp * ('istate option)> =     
    ...
    sim 
        ...
        (bound "next_path" 0 1 &&& bound "next_signal" 0 1 &&& bound "next_vul" 0 1 &&& bound "next_lst" 0 1 &&& bound "next_mapk" 0 1 &&& bound "next_sur2" 0 1)
        //"path"= left and right LS
        //"signal"=Notch
        //Vul, mapk and lst
        (context.MkAnd 
            [|
            (* Vul rules *)
            (var "prev_input" === int 0) ==> (var "next_vul" === int 0)
            ...
            (var "prev_mapk" === int 2) ==> (var "next_path" === int 2)
            (* lst rules *)
            (var "prev_signal" === int 0) ==> (var "next_lst" === int 0)
            (var "prev_signal" === int 1) ==> (var "next_lst" === int 1)
            (var "prev_signal" === int 2) ==> (var "next_lst" === int 2)
            (* sur2 rules *)
            (var "prev_mapk" === int 0) ==> (var "next_sur2" === int 0)
            (var "prev_mapk" === int 1) ==> (var "next_sur2" === int 1)
            (var "prev_mapk" === int 2) ==> (var "next_sur2" === int 2)
            (* Signal rules *)
            (((var "prev_left_path" === int 0) &&& (var "prev_right_path" === int 0))) ==> (var "next_signal" === int 0)

            (((var "prev_left_path" << var "prev_right_path") &&& (var "prev_right_path" === int 1))) &&& (var "prev_sur2" === int 0) ==> (var "next_signal" === int 1)
            (((var "prev_left_path" << var "prev_right_path") &&& (var "prev_right_path" === int 2))) &&& (var "prev_sur2" === int 0) ==> (var "next_signal" === int 2)
            (((var "prev_right_path" << var "prev_left_path") &&& (var "prev_left_path" === int 1)))  &&& (var "prev_sur2" === int 0) ==> (var "next_signal" === int 1)
            (((var "prev_right_path" << var "prev_left_path") &&& (var "prev_left_path" === int 2)))  &&& (var "prev_sur2" === int 0) ==> (var "next_signal" === int 2)

            (((var "prev_left_path" << var "prev_right_path") &&& (var "prev_right_path" === int 1))) &&& (var "prev_sur2" === int 1) ==> (var "next_signal" === int 0)
            (((var "prev_left_path" << var "prev_right_path") &&& (var "prev_right_path" === int 2))) &&& (var "prev_sur2" === int 1) ==> (var "next_signal" === int 2)
            (((var "prev_right_path" << var "prev_left_path") &&& (var "prev_left_path" === int 1)))  &&& (var "prev_sur2" === int 1) ==> (var "next_signal" === int 0)
            (((var "prev_right_path" << var "prev_left_path") &&& (var "prev_left_path" === int 2)))  &&& (var "prev_sur2" === int 1) ==> (var "next_signal" === int 2)

            (((var "prev_left_path" << var "prev_right_path") &&& (var "prev_right_path" === int 1))) &&& (var "prev_sur2" === int 2) ==> (var "next_signal" === int 0)
            (((var "prev_left_path" << var "prev_right_path") &&& (var "prev_right_path" === int 2))) &&& (var "prev_sur2" === int 2) ==> (var "next_signal" === int 0)
            (((var "prev_right_path" << var "prev_left_path") &&& (var "prev_left_path" === int 1)))  &&& (var "prev_sur2" === int 2) ==> (var "next_signal" === int 0)
            (((var "prev_right_path" << var "prev_left_path") &&& (var "prev_left_path" === int 2)))  &&& (var "prev_sur2" === int 2) ==> (var "next_signal" === int 0)
...
//
            ...
            bound "prev_signal" 0 3

            bound "next_signal" 0 3
