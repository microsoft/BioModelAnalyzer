...
type StemCellParamForm() as this =
    inherit ParamFormBase (Width=1200, Height = 1100)
    ...
    do
        ...
        division_prob_o2_chart.Titles.Add("The probability of stem cell division") |> ignore
        ...
        division_prob_o2_chart_area.AxisY.Title <- "The probability"
        ...
        division_prob_density_chart.Titles.Add("The probability of stem cell division") |> ignore
        ...
        division_prob_density_chart_area.AxisY.Title <- "The probability"
