...
type ModelParameters() =
    ...
    static let mutable stem_division_prob_cell_density = ref (LogisticFunc(min = Point(0.3*density_limits.Max, 0.), max = Point(0.2*density_limits.Max, 1.)))
    ...
    static let mutable nonstem_interval_between_divisions = IntInterval(30, 60)
    ...
    static let mutable average_cell_radius = 10. // micrometers
    static let mutable repulsive_force = ref (ShiftExponentFunc(p1 = Point(max_displacement, max_repulsive_force),
                                                            p2 = Point(0.9, max_repulsive_force*0.01), ymin = 0.))
    static let mutable friction_coeff = 2.
    static let mutable max_friction_coeff = 10.
    static let mutable diffusion_coeff = 10.
