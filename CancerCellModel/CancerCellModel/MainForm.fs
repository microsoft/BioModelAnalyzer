...
type CellStatisticsForm ((*cell_stat: CellStatistics, ext_stat: ExtStatistics*)) =
    ...
    do
        ...
        stem_prop_dialog.FormClosing.Add(ParamFormBase.hide_form stem_prop_dialog)
        nonstem_prop_dialog.FormClosing.Add(ParamFormBase.hide_form nonstem_prop_dialog)
        extstate_prop_dialog.FormClosing.Add(ParamFormBase.hide_form extstate_prop_dialog)
        extstate_dialog.FormClosing.Add(ParamFormBase.hide_form extstate_dialog)
        activity_stat_dialog.FormClosing.Add(ParamFormBase.hide_form activity_stat_dialog)
        plot_stat()
