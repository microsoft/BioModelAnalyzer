...
type ParamFormBase() =
    ...
    static member y_interval with get() = 20
    static member initial_location with get() = Drawing.Point(30, 30)
    static member label_width with get() = 20
    static member max_label_width with get() = 100
    static member max_label_height with get() = 40
    ...
    static member refresh_logistic_func_chart(chart: Chart, x1_textbox: TextBox, x2_textbox: TextBox,
        ...
        let (x1_default, x2_default, max_default) = ModelParameters.NonStemDivisionProbParam
        ...
        series.Points.Clear()
        ParamFormBase.func_plot(series, (ModelParameters.logistic_func(mu, s, !max)), x_limits)
    ...
    static member refresh_exp_func_chart(chart: Chart, x3_textbox: TextBox, max_textbox: TextBox,
        ...
        let (x3_default, max_default) = ModelParameters.NonStemToStemProbParam
        let (x3, max) = (ref x3_default, ref max_default)
    ...
    static member create_logistic_func_controls(parent: Control, prev_control: Control, chart: Chart,
                                                ...
                                                param: float*float*float, x_limits: float*float) =
        ...
        if prev_control <> null
            then ParamFormBase.place_control_below(prev_control, panel)
        ...
        //max_label.Width <- 30
        max_label.MaximumSize <- Drawing.Size(ParamFormBase.max_label_width, ParamFormBase.max_label_height)
    ...
    static member create_exp_func_controls(parent: Control, prev_control: Control, chart: Chart, 
        ...
        //x3_label.Width <- 400
        x3_label.MaximumSize <- Drawing.Size(ParamFormBase.max_label_width * 2, ParamFormBase.max_label_height)
        ...
        let max_label = new Label()
        //max_label.Width <- 30
        max_label.MaximumSize <- Drawing.Size(ParamFormBase.max_label_width * 2, ParamFormBase.max_label_height)
        max_label.AutoSize <- true
