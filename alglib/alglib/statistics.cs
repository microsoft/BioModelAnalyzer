    ...
    public class basestat
    {
        ...
        *************************************************************************/
            ...
            int nfeatures)
        {
            ...
            //
            if( (double)(apserv.inttoreal(npoints)*apserv.inttoreal(nfeatures)*apserv.log2(nfeatures))<(double)(basecasecost) )
            {
        ...
        *************************************************************************/
            ...
            int basecasecost)
        {
            ...
            //
            problemcost = apserv.inttoreal(i1-i0)*apserv.inttoreal(nfeatures)*apserv.log2(nfeatures);
