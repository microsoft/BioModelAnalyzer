        ...
        var processGesture = function (gesture) {
            ...
            if (gesture.Type == "Pan") {
                ...
                if (plot.visibleRectConstraint !== undefined) {
                    ...
                    var checkX = plot.aspectRatio === undefined || plot.aspectRatio >= 1;
                    if (checkX && Math.abs(newPlotRect.width - vis.width) < (vis.width / 1000)) {
                        newPlotRect.x = vis.x;
    
                        if (plot.aspectRatio !== undefined)
                            newPlotRect.y = vis.y;
                    ...
                    var checkY = plot.aspectRatio === undefined || plot.aspectRatio < 1;
                    if (checkX && Math.abs(newPlotRect.height - vis.height) < (vis.height / 1000) || plot.aspectRatio !== undefined && xConstrained) {
                        newPlotRect.y = vis.y;
                    ...
                    xConstrained = xConstrained || checkY;
                    yConstrained = yConstrained || checkX;
                    ...
                    if (xConstrained && yConstrained) {
                        ...
                        console.log("Constraint skipped: " + newPlotRect.width + ", " + vis.width);
                    }
                }
                */
