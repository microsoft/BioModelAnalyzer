describe("model", function () {
    describe("BMA.Model.Variable", function () {
        ...
        it("creates BMA.Model.Variable and apply function GetJSON", function () {
            var variable = new BMA.Model.Variable(id, containerId, type, name, rangeFrom, rangeTo, formula);
    ...
    describe("BMA.Model.Relationship", function () {
        var id = 245, fromVariableId = 312, toVariableId = 256, type = "testtype";

        it("creates BMA.Model.Relationship with right properties", function () {
        ...
        it("creates BMA.Model.Relationship and apply function GetJSON", function () {
            var relationship = new BMA.Model.Relationship(id, fromVariableId, toVariableId, type);
    ...
    describe("BMA.Model.BioModel", function () {
        ...
        it("creates BMA.Model.BioModel", function () {
        ...
        it("creates BMA.Model.BioModel and changes its name", function () {
            var biomodel = new BMA.Model.BioModel(name, variables, relationships);
        ...
        it("creates BMA.Model.BioModel and clones it to the second BioModel using 'Clone()' function", function () {
            var biomodel = new BMA.Model.BioModel(name, variables, relationships);
        ...
        it("creates BMA.Model.BioModel and get existing variable from it using function 'GetVariableById(id)'", function () {
            var biomodel = new BMA.Model.BioModel(name, variables, relationships);
            var v = biomodel.GetVariableById(34);
            expect(v).toEqual(v1);
        });

        it("creates BMA.Model.BioModel and try to get not existing variable from it using function 'GetVariableById(id)', should return undefined", function () {
            var biomodel = new BMA.Model.BioModel(name, variables, relationships);
            var v = biomodel.GetVariableById(1);
            expect(v).toEqual(undefined);
        });

        it("creates BMA.Model.BioModel and apply function 'GetJSON()'", function () {
            var biomodel = new BMA.Model.BioModel(name, variables, relationships);
    ...
    describe("BMA.Model.VarialbeLayout", function () {
        var id = 123, positionX = 18, positionY = 85, cellX = 91, cellY = 64, angle = 37;

        it("creates BMA.Model.VarialbeLayout with right properties", function () {
    ...
    describe("BMA.Model.ContainerLayout", function () {
        var id = 134, size = 18, positionX = 64, positionY = 85;

        it("creates BMA.Model.ContainerLayout with right properties", function () {
    ...
    describe("BMA.Model.Layout", function () {
        ...
        it("creates BMA.Model.Layout with right properties", function () {
        ...
        it("creates BMA.Model.Layout and clones it to the second Layout using 'Clone()' function", function () {
            var layout = new BMA.Model.Layout(containers, varialbes);
        ...
        it("creates BMA.Model.Layout and apply function 'GetContainerById(id)'", function () {
            var layout = new BMA.Model.Layout(containers, varialbes);
            var c = layout.GetContainerById(CL2.Id);
            expect(c).toEqual(CL2);
        });

        it("creates BMA.Model.Layout and try to apply function 'GetContainerById(id) with not existing id, should return undefined'", function () {
            var layout = new BMA.Model.Layout(containers, varialbes);
