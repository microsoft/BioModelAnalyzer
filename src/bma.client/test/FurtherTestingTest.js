describe("Further Testing", function () {
    ...
    it("creates a button and executes 'FurtherTestingRequested' command on click", function () {
        editor.furthertesting();
    ...
    it("can get button from widget with calling 'GetToggler' function", function () {
        editor.furthertesting();
    ...
    it("creates table in widget with data option", function () {
        editor.furthertesting();
    ...
    it("destroy table with results when 'data' option is undefined", function () {
        editor.furthertesting();
        var data = ["q", "w", "e", "q, w, e, r, t, y"];
        editor.furthertesting({ data: data });
