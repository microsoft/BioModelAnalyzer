describe("Simulation Expanded", function () {
    ...
    it("should create Run button and execute 'RunSimulation' command on click", function () {
        widget.simulationexpanded();
    ...
    it("should create widget with variables and append coloredtablewiever", function () {
        var variables = [];
    ...
    it("should apppend progression table with 'interval','init','data' options", function () {
        var variables = [];
        variables[0] = ["#FFFFFF", false, "var1", "3-15"];
    ...
    it("should execute 'RunSimulation' command with right parameters", function () {
        var variables = [];
        variables[0] = ["#FFFFFF", false, "var1", "3-15"];
        variables[1] = ["#FFFFFF", true, "var2", "0-3"];
        var interval = [];
    ...
    it("should initially set num option", function () {
        widget.simulationexpanded();
    ...
    it("should change num option", function () {
        widget.simulationexpanded();
        var span = widget.children().eq(1).children().eq(0);
