...
(function (BMA) {
    (function (Elements) {
        ...
        function CreateElementsRegistry() {
            var result = [];

            var createSvgElement = function createSvgElement(type, x, y, scale) {
            ...
            var createSvgPath = function createSvgPath(data, color, x, y, scale) {
