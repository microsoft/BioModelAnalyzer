                        ...
                        switch (behavior) {
                            case "toggle":
                                if (that.listOptions[ind].toggle === undefined) {
                                    ...
                                    var button = $('<button></button>').appendTo($(child)).addClass("hoverable");
                                    if (value)
                            ...
                            case "increment":
                                if (that.listOptions[ind].increment === undefined) {
                                    ...
                                    var plus = $('<button>+</button>').addClass("plusminus").appendTo($(child)).addClass("hoverable");
                                    var minus = $('<button>-</button>').addClass("plusminus").appendTo($(child)).addClass("hoverable");
