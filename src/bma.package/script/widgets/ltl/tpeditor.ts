...
(function ($) {
    $.widget("BMA.temporalpropertieseditor", {
        ...
        _create: function () {
            ...
            drawingSurface.drawingsurface({ minZoomWidth: 400 });
            drawingSurface.drawingsurface({ maxZoomWidth: Number.POSITIVE_INFINITY });
            drawingSurface.drawingsurface({ minZoomHeight: 200 });
            drawingSurface.drawingsurface({ maxZoomHeight: Number.POSITIVE_INFINITY });
