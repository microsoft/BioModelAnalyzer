    ...
    export module LTLOperations {
        ...
        export class OperatorsRegistry {
            ...
            constructor() {
                ...
                this.operators.push(new Operator('AVG', Number.POSITIVE_INFINITY, functionformulacreator('avg'), true));
                this.operators.push(new Operator('MIN', Number.POSITIVE_INFINITY, functionformulacreator('min'), true));
                this.operators.push(new Operator('MAX', Number.POSITIVE_INFINITY, functionformulacreator('max'), true));

                this.operators.push(new Operator('CEIL', 1, formulacreator('ceil'), true));
                this.operators.push(new Operator('FLOOR', 1, formulacreator('floor'), true));

                this.operators.push(new Operator('/', 2, operatorformulacreator('/'), false));
                this.operators.push(new Operator('*', Number.POSITIVE_INFINITY, operatorformulacreator('*'), false));
                this.operators.push(new Operator('+', Number.POSITIVE_INFINITY, operatorformulacreator('+'), false));
                this.operators.push(new Operator('-', Number.POSITIVE_INFINITY, operatorformulacreator('-'), false));
            }
        }
