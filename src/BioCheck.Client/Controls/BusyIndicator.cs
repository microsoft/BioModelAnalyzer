...
namespace BioCheck.Controls
{
    ...
    [TemplatePart(Name = TemplateParts.CancelButton, Type = typeof(Button))]
    public class BusyIndicator : ContentControl
    {
        ...
        {
            ((BusyIndicator)d).OnIsCancellableChanged(e);
        }

        protected virtual void OnIsCancellableChanged(DependencyPropertyChangedEventArgs e)
        {
            CancelVisibility = IsCancellable ? Visibility.Visible : Visibility.Collapsed;
        }
        ...
        /// <summary>
        /// Identifies the CancelVisibility dependency property.
        /// </summary>
