...
{
    /// <summary>
    /// The control for displaying a variable in a cell
    /// </summary>
    ...
    public class VariableView : Control,
                                DragDropService<VariableViewModel>.IDragSource,
                                IRelationshipTarget,
                                IDisposable
    {
        ...
        public const int DefaultFixedWidth = 32;
        public const int DefaultFixedHeight = 32;

        private IContextBarService contextBarService;

        public VariableView()
        {
            this.DefaultStyleKey = typeof(VariableView);

            this.Loaded += VariableControl_Loaded;
        }

        void VariableControl_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
        ...
        private void OnMouseDoubleClick()
        {
            ...
            // Mark the MouseLeftButtonDown event as handled if we're in the hand or relationship mode, or we will start moving the variable.
            toolbarVM.MouseDownIsHandled = true;
        ...
        public static readonly DependencyProperty FixedWidthProperty =
            DependencyProperty.Register("FixedWidth", typeof(int), typeof(VariableView), new PropertyMetadata(DefaultFixedWidth));
        ...
        public static readonly DependencyProperty FixedHeightProperty =
            DependencyProperty.Register("FixedHeight", typeof(int), typeof(VariableView), new PropertyMetadata(DefaultFixedHeight));
        ...
        public static readonly DependencyProperty IsCheckedProperty =
            DependencyProperty.Register("IsChecked", typeof(bool), typeof(VariableView), new PropertyMetadata(false, OnIsCheckedChanged));

        private static void OnIsCheckedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((VariableView)d).OnThisIsCheckedChanged(d, e);
        }
        ...
        public FrameworkElement DragCursor
        {
            get
            {
                if (dragCursor == null)
                {
                    ...
                    if (this.Style != null)
                        variable.Style = this.Style;

                    variable.Opacity = 0.6;
                    variable.Width = variable.FixedWidth;
                    variable.Height = variable.FixedHeight;
                    variable.DataContext = this.DataContext;
                    this.Opacity = 0.4;
        ...
        public VariableViewModel Payload
        {
            get { return this.DataContext as VariableViewModel; }
        }
        ...
        public static readonly DependencyProperty ShowStabilityProperty =
            DependencyProperty.Register("ShowStability", typeof(bool), typeof(VariableView), new PropertyMetadata(false, OnShowStabilityChanged));

        private static void OnShowStabilityChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((VariableView)d).OnThisShowStabilityChanged(d, e);
        }
        ...
        public static readonly DependencyProperty IsStableProperty =
            DependencyProperty.Register("IsStable", typeof(bool), typeof(VariableView), new PropertyMetadata(true, OnIsStableChanged));

        private static void OnIsStableChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((VariableView)d).OnThisIsStableChanged(d, e);
        }
